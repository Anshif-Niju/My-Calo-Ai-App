...
// 🚀 Admin Nav Items with related SVG Icons
    ...
    <>
      <nav className="hidden lg:flex fixed top-0 left-0 right-0 z-50 h-16 items-center px-8 justify-between border-b" style={{ background: "#ffffff", borderColor: "#e2e8f0" }}>
        <div className="flex items-center gap-3">
          ...
          <span className="font-black text-xl leading-none" style={{ color: "#0f172a", fontFamily: "var(--font-head)" }}>
            MyCalo AI Admin
          </span>
        </div>
      ...
      {/* 📱 Mobile bottom navbar (Glassmorphism B&W) */}
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-50 border-t backdrop-blur-sm" style={{ background: "rgba(255, 255, 255, 0.9)", borderColor: "#e2e8f0" }}>
